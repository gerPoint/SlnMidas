...
namespace Apresentacao
{
    public partial class frmEmissaoRomaneio : Form
    {
        ...
        private void printDocumentImprimir_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(lblFornecedor.Text, lblFornecedor.Font, Brushes.Black, new Point(45, 120));
            ...
            e.Graphics.DrawString(lblFruta.Text, lblFruta.Font, Brushes.Black, new Point(92, 160));
